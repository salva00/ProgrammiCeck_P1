...
public:
    ...
    static void displayAccount(Account accountToDisplay) {  // a static function can be called even when an object of the class is not defined
        std::cout << "account: " << accountToDisplay.getName() << " balance is $"
